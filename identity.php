...
<section id="services">
  ...
  <h2 class="title">Log in As </h2>
    <div class="row">
      <div class="col-md-6 services">
        <img src="image/admin2.png" class="service-img">
        <h4><a href="adminlogin.php">Admin</a></h4>
        
      </div>
      <div class="col-md-6 services">
        <a href="registration.php"><img src="image/user3.png" class="service-img"></a>
        <h4><a href="userlogin.php">User</a></h4>
        <br>
