...
while($res=mysqli_fetch_array($query))
{
    ...
    <td><a href="updatetrain.php?id=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="UPDATE"> <i class="fa fa-edit" aria-hidden="true"></i></td>
    <td><a href="deletetrain.php?idth=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
