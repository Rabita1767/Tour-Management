    ...
    <div class="header">
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    <li>
                        <a href="indexdemo.php">Home</a></li>
                        <li><a href="aboutdemo.php">About Us</a></li>
            ...
            <div class="reg-btn">
                <a href="identity.php">Register Now</a>
            </div>
        </div>
        <div class="banner">
            <div class="app-text">
                <h3>Why we are the best</h3>
                <p>We provide online booking services and  provide you a hassel free journey</p>
