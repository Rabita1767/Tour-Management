...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="client.php.php" >Clients</a>
        </li>
  ...
  <h2 class="title">Clients </h2>
    <div class="row">
      <div class="col-md-3 services">
        ...
        <h4><a href="packageclient.php">Tour Packages</a></h4>
        
      </div>
      <div class="col-md-3 services">
        <a href=""><img src="image/ratri.png" class="service-img"></a>
        <h4><a href="hotelclient.php">Hotel</a></h4>
        
      </div>
      <div class="col-md-3 services">
        <a href=""><img src="image/train-removebg.png" class="service-img"></a>
        <h4><a href="trainclient.php">Train</a></h4>
