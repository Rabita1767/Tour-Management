...
$selectquery="select * from register_user_train ";
...
while($res=mysqli_fetch_array($query))
{
    ...
    <td><?php echo $res['no_of_ticket']?></td>
    <td><a href="updatetclient.php?id=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="UPDATE"> <i class="fa fa-edit" aria-hidden="true"></i></td>
    <td><a href="deletetclient.php?idth=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
